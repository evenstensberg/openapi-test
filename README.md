# testy OpenAPI Specification
[![Build Status](https://travis-ci.com/evenstensberg/test-api.svg?branch=master)](https://travis-ci.com/evenstensberg/test-api)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://evenstensberg.github.io/test-api/)
- [SwaggerUI](https://evenstensberg.github.io/test-api/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://evenstensberg.github.io/test-api/openapi.json) [YAML](https://evenstensberg.github.io/test-api/openapi.yaml)
